              ...
              {loading ? (
                ...
                <>
                  ...
                  <button
                    ...
                    type='submit'
                    className='group mt-2 relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-indigo-700 fooutline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                  >
                    Delete Category
                  </button>
                </>
